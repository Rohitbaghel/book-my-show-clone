...
const movieSchema = new mongoose.Schema({
    ...
    rating : {percentage : {type : Number, required : true}, no_of_ratings : {type : Number, required : true}},
    ...
    cast : [{original_name : {type : String, required : true}, character : {type : String, required : true}, cast_image : {type : String, required : true}}],
    crew : [{name : {type : String, required : true}, crew_position : {type : String, required : true}, crew_image : {type : String, required : true}}]
