...
import {AiOutlineDown, AiOutlineRight} from "react-icons/ai";
 ...
 export const Laughter = () =>{ 
    ...
    return <>
        <div style={{backgroundColor:'#F5F4F4'}} className='flex gap-5 mx-12'>
            <div className='w-2/6 ' >
                ...
                <div className='my-10 bg-white px-4'>
                    <div className='flex justify-between'>
                        <div className='flex'>
                       <AiOutlineDown className='mt-3 mr-1 '/><p className='text-lg text-red-600 py-2'>Languages</p>
                        </div>
                ...
                <div className='my-10 bg-white px-4'>
                    <div className='flex justify-between'>
                        <div className='flex'>
                       <AiOutlineDown className='mt-3 mr-1 '/><p className='text-lg text-red-600 py-2'>Generes</p>
                        </div>
                   <div className='py-2'>Clear</div>
                    </div>
                ...
                <div className='my-10 bg-white px-4'>
                    <div className='flex justify-between'>
                        <div className='flex'>
                       <AiOutlineDown className='mt-3 mr-1 '/><p className='text-lg text-red-600 py-2'>Format</p>
                        </div>
                   <div className='py-2'>Clear</div>
                    </div>
                    <div className='grid grid-cols-3 gap-3'>
            ...
            <div className=' w-full'>
                <h4 className='text-2xl font-semibold text-left'>Movies in National Capital Region (NCR)</h4>
                <div className='flex gap-2 my-10'>
                    <div className="border-2 bg-white text-red-600 text-lg px-2 py-1 rounded-2xl">English</div>
                    <div className="border-2 bg-white text-red-600 text-lg px-2 py-1 rounded-2xl">Hindi</div>
                    <div className="border-2 bg-white text-red-600 text-lg px-2 py-1 rounded-2xl">English 7D</div>
                    <div className="border-2 bg-white text-red-600 text-lg px-2 py-1 rounded-2xl">Malayalam</div>
                    <div className="border-2 bg-white text-red-600 text-lg px-2 py-1 rounded-2xl">Punjabi</div>
                    <div className="border-2 bg-white text-red-600 text-lg px-2 py-1 rounded-2xl">Telugu</div>
                </div> 
                <div className='bg-white flex justify-between my-10'>
                    <div className="text-2xl font-semibold px-4 py-4">Coming Soon</div>
                    <div className='flex px-4 py-4 gap-1 text-red-600'>Explore Upcoming Movies <AiOutlineRight className='mt-1 '/></div>
                </div>
                {/* movies */}
