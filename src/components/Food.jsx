...
export const Food=() => {
    ...
    return <>
        <div className="flex">
            <div className="px-10">
                <div>
                <img src="https://in.bmscdn.com/promotions/cms/creatives/1637860677199_728x100.png" alt="12" className='w-full'/>
                </div>
                {/* food section */}
                <div style={{backgroundColor:'#FFFFFF'}}>
                    <h2 className='text-center text-2xl'>Grab a <span className="text-2xl text-red-600">bite!</span></h2>
                    <p className='text-center'>Prebook Your Meal and Save More!</p>
                    <div className='grid grid-cols-5 lg:mx-60'>
                        <div>
                            <button className='border rounded-lg px-4 bg-red-600'>All</button>
                        </div>
                        <div>
                    ...
                    <div className='grid grid-cols-3 gap-2'>
                        {food.map(({food_image,food_name,food_tag,food_price,_id}) => {
                            return (
                                <div key={_id}> 
                                    ...
                                    <div className='flex border justify-between '>
                                        ...
                                        <div className=''>
                                            ...
                                            <button className='border rounded-lg  mt-2 text-red-600 '>Add</button>
                                            </div>
                                    </div>
                                </div>
                            )
            ...
            <div>
                ...
                <p>Your current state is <span>Delhi</span></p>
                <div className='flex justify-between my-4' style={{backgroundColor:'#FFFDDD'}}>
                    <div>
                        <p>Amount Payable</p>
                    </div>
                    <div>
                ...
                <button className="border px-8 text-2xl font-bold hover:bg-red-600">Buy Ticket</button>
                <p>You can cancel the tickets 20 min(s) before the show. Refunds will be done according to Cancellation Policy</p>
            </div>
    </div>
