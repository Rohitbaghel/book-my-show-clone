      ...
      <div>
        <div className='flex border-2 bg-black'>
          ...
          <div className=''>
            ...
            <div className='flex justify-between text-white border px-2 py-2 my-4 rounded-xl' style={{backgroundColor:'#333333'}}>
              <div className=''>
                      ...
                      <div>
                          ...
                          <div className='grid grid-cols-2 gap-8 my-4'>
                              <div className='border'>
                                  ...
                                  <p className='my-10 text-lg font-bold'>#SuperDirection #GreatActing #WowMusic #Bi....</p>
                                  <div className='flex  justify-between '>
                                      <div className='flex'>
                              ...
                              <div className='border'>
                                  ...
                                  <p className='my-10 text-lg font-bold'> #GreatActing #WowMusic </p>
                                  <div className='flex  justify-between '>
                                      <div className='flex'>
                                          <AiOutlineLike className='text-3xl mr-2 mb-1' />
                                          <div>1.5K </div>
